...
```
## OUTPUT:
![WhatsApp Image 2026-03-30 at 12 33 31 PM](https://github.com/user-attachments/assets/870c7dda-f9d3-49e8-a129-b882877d5cfb)

## RESULT:
Thus the design of Band pass FIR digital filter using hanning window was done and
